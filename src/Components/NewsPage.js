...
const NewsPage = () => {
    ...
    useEffect(() => {
        const jobNews = async () => {
            const data = await fetch("https://newsapi.org/v2/everything?q=employment&from=2023-03-15&to=2023-03-17&sortBy=popularity&apiKey=2a37a4136e984668870242250e6553fd")
